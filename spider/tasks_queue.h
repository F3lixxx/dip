...
{
private:	
	std::queue<url_item>   urls_queue;	//очереь урлов на сканирование	 
...
public:	
	...
	bool not_empty(); // очередь не пуста?
	bool is_empty(); // очередь пуста?	

	int get_queue_size(); //получить текущий размер очереди	
};
